...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		// 트랙리스트에 각각 트랙객체 추가
		trackList.add(new Track("MightyLoveTitle.png", "MightyLove_startImage.png", "MightyLove_gameImage.png", "Mighty Love_selected.mp3", "Joakim Karud - Mighty Love.mp3"));		//index 0
		trackList.add(new Track("energyTitle.png", "energy_startImage.png", "energy_gameImage.png", "Energy_selected.mp3", "Bensound - Energy.mp3"));												//index 1
		trackList.add(new Track("wildFolwerTitle.png", "wildFlower_startImage.png", "wildFlower_gameImage.png", "Wild Flower_selected.mp3", "Joakim Karud - Wild Flower.mp3"));			//index 2
		...
		startBtn.addMouseListener(new MouseAdapter() {		// 마우스 오버시 이미지 아이콘 변경
			...
			public void mousePressed(MouseEvent e) {
				...
				btnPressMusic.start();
				introMusic.close(); 		// 시작버튼을 눌렀을때 인트로 뮤직 종료
				selectTrack(0);
	...
	public void selectTrack(int nowSeleted) {
		...
		seletedMusic = new Music(trackList.get(nowSeleted).getStartMusic(), true);
		seletedMusic.start();
	}
