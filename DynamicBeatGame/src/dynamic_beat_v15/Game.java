	...
	public void dropNotes(String titleName) {
		...
		if (titleName.equals("Joakim Karud - Mighty Love") && difficulty.equals("Easy")) {
			...
			beats = new Beat[] { new Beat(startTime + gap * 1, "S"), new Beat(startTime + gap * 3, "D"),
					...
					new Beat(startTime + gap * 118, "Space"), new Beat(startTime + gap * 126, "J"),
					...
					new Beat(startTime + gap * 223, "K"), new Beat(startTime + gap * 223, "L"),
					...
					new Beat(startTime + gap * 340, "S"), new Beat(startTime + gap * 332, "Space"),
					new Beat(startTime + gap * 340, "D"), new Beat(startTime + gap * 336, "Space"),
